...
class SquatsLiftingWeightWannatry extends StatefulWidget {
  const SquatsLiftingWeightWannatry({Key? key}) : super(key: key);

  @override
  State<SquatsLiftingWeightWannatry> createState() => _DumbBellPressWannaTry();
}

class _DumbBellPressWannaTry extends State<SquatsLiftingWeightWannatry>

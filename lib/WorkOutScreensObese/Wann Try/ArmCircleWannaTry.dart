...
class ArmCircleWannaTry extends StatefulWidget {
  const ArmCircleWannaTry({Key? key}) : super(key: key);

  @override
  State<ArmCircleWannaTry> createState() => _DumbBellPressWannaTry();
}

class _DumbBellPressWannaTry extends State<ArmCircleWannaTry>

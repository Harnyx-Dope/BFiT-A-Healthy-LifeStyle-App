...
class DeadliftsWannaTry extends StatefulWidget {
  const DeadliftsWannaTry({Key? key}) : super(key: key);

  @override
  State<DeadliftsWannaTry> createState() => _DumbBellPressWannaTry();
}

class _DumbBellPressWannaTry extends State<DeadliftsWannaTry>

...
class WeightPushUpsWannaTry extends StatefulWidget {
  const WeightPushUpsWannaTry({Key? key}) : super(key: key);

  @override
  State<WeightPushUpsWannaTry> createState() => _DumbBellPressWannaTry();
}

class _DumbBellPressWannaTry extends State<WeightPushUpsWannaTry>

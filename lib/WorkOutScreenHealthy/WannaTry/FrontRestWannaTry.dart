...
class FrontRestWannaTry extends StatefulWidget {
  const FrontRestWannaTry({Key? key}) : super(key: key);

  @override
  State<FrontRestWannaTry> createState() => _DumbBellPressWannaTry();
}

class _DumbBellPressWannaTry extends State<FrontRestWannaTry>
